...
import { createNotification, CreateNotificationData, getNotificationsByUser, getUnreadCountByUser, markAllNotificationsAsRead, markNotificationAsRead } from "../repositories/notification.repository.js";
...
export const listNotificationsService = async (userId: string, query: { page?: number; limit?: number; unread?: boolean }) => {
  ...
  return getNotificationsByUser(userId, query.page ?? 1, query.limit ?? 20, query.unread === true);
};
